...
public class Main extends Application {
    ...
    private final ObservableList<Task> data =
            FXCollections.observableArrayList(
                    new Task("Wash clothes", "Friday", "12:00pm", "Tomorrow", "Mom", "Do ASAP"),
                    new Task("Java project", "Monday", "9:38am", "May 10", "Dr Ruslan", "Finish on time"));
    ...
    public void start(Stage primaryStage)  throws Exception{
        ...
        addDescription.setStyle("-fx-margin: 0 20 0 0;");
